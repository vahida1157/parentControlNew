...
interface ChildSettingsDao {
	...
	@Query(
        ...
        SET is_time_limit_active = :isActive, 
            daily_time_limit_mins = :limitMins,
            is_exercise_reward_enabled = :isRewardEnabled,
            max_reward_seconds_per_day = :maxRewardSeconds,
            reward_seconds_per_point = :rewardSecondsPerPoint,
            is_synced = 0,
